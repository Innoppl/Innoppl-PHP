...
class Simplexml{
   ...
   public function __construct() {
        //log_mesage('debug', 'Simplexml library loaded.');
   }
   ...
   function xml_parse($data){
    ...
    /**
     * Convert XML object into indexed array
     * @param object XML data to convert
     * @param array $arrSkipIndices keys to skip
...
/* End of File /application/libraries/Simplexml.php */